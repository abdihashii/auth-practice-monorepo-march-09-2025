...
export const ACCESS_TOKEN_COOKIE_NAME_PROD
= `${AUTH_TOKEN_COOKIE_PREFIX_PROD}accessToken`;
export const ACCESS_TOKEN_COOKIE_NAME_DEV
= `${AUTH_TOKEN_COOKIE_PREFIX_DEV}accessToken`;

// Prod and dev cookie names for the refresh token
export const REFRESH_TOKEN_COOKIE_NAME_PROD
= `${AUTH_TOKEN_COOKIE_PREFIX_PROD}refreshToken`;
export const REFRESH_TOKEN_COOKIE_NAME_DEV
= `${AUTH_TOKEN_COOKIE_PREFIX_DEV}refreshToken`;
